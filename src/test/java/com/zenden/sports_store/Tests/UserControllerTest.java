...
public class UserControllerTest {
    ...
    public void testConfirmUser() throws Exception {
        // Assuming confirm redirects to another page, we cannot test the redirect itself easily,
    ...
    public void testRole() throws Exception {
        String token = "mockToken";
        when(jwtTokenUtils.getRolesFromToken(token)).thenReturn(List.of("ROLE_USER", "ROLE_ADMIN"));
    ...
    public void testReadAllUsers() throws Exception {
        Page<UserReadDTO> page = new PageImpl<>(Collections.singletonList(userReadDTO));
    ...
    public void testUpdateUser() throws Exception {
        when(userService.update(eq(1L), any(UserCreateUpdateDTO.class))).thenReturn(userReadDTO);
