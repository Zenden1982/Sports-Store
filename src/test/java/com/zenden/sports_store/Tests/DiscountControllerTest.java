...
// Page<DiscountReadDTO> page = new
// PageImpl<>(Collections.singletonList(discountReadDTO));
// when(discountService.readAll(anyInt(), anyInt(), anyString(),
// ArgumentMatchers.any(DiscountFilter.class)))
// .thenReturn(page);
...
// when(discountService.update(eq(1L),
// ArgumentMatchers.any(DiscountCreateUpdateDTO.class)))
// .thenReturn(discountReadDTO);
